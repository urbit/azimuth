...
contract TestVotes
{
  ...
  {
    Assert.isFalse(votes.castConcreteVote(0, concrProp, true),
    ...
    Assert.isFalse(votes.castConcreteVote(0, concrProp, false),
      "should not be majority yet");
  ...
  function testMajorityConcreteVote()
  {
    Assert.isFalse(votes.castConcreteVote(0, concrProp, true),
      "should not be majority yet");
    Assert.isTrue(votes.castConcreteVote(1, concrProp, true),
      "should be majority");
  ...
  {
    votes.castAbstractVote(0, abstrProp, true);
    Assert.equal(votes.abstractVoteCounts(abstrProp), uint256(1),
      "should have added vote");
    votes.castAbstractVote(0, abstrProp, false);
  ...
  {
    votes.castAbstractVote(0, abstrProp, true);
    votes.castAbstractVote(1, abstrProp, true);
